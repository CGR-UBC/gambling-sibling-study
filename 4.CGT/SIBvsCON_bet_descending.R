...
setwd("/Users/eoldfiel/Data/github/SIBSTUDY_slots/4.CGT/analysis/model2_bet/SIBvsCON/descending")
...
write.csv(p,file ='SIBvsCON_bet_model_predict_descending.csv',row.names = FALSE)
