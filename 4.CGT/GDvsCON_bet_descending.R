...
setwd("/Users/eoldfiel/Data/github/SIBSTUDY_slots/4.CGT/analysis/model2_bet/GDvsCON/descending")
...
#### descending linear model 

data<-subset(data,a.or.d==c("d"))
...
write.csv(p,file ='GDvsCON_bet_model_predict_descending.csv',row.names = FALSE)
